...
public class CloudSim_HPC {
	...
	public static void main(String[] args) {
		Log.println("Starting CloudSim-HPC...");
		...
		try {
			...
			// VM description #Hpc6a
			int vmid = 0;
			int mips = 254400;
			long size = 10000; // image size (MB)
			int ram = 384000; // vm memory (MB)
			long bw = 100000;
			int pesNumber = 1; // number of cpus
			String vmm = "Hpc6a"; // VMM name
			...
			// Cloudlet properties
			int id = 0; // Eindeutige ID
            long length = 400000000;// Anzahl der MIPS (Rechenzeit)
            long fileSize = 20000; // Größe der Eingabedaten (MB)
            long outputSize = 300; // Größe der Ausgabedaten (MB)
	...
	private static Datacenter createDatacenter(String name) {
		...
		double costPerStorage = 0.0; // the cost of using storage in this
										// resource
